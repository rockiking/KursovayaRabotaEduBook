        ...
        container.innerHTML = materials.map(material => `
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-field"><strong>Автор:</strong> ${material.authorName || 'Unknown'}</div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (addMaterialBtn) {
        if (['Author', 'Admin'].includes(currentUser.role)) {
            addMaterialBtn.style.display = 'block'; // показываем
        } else {
            addMaterialBtn.style.display = 'none';  // скрываем
        }
    }
